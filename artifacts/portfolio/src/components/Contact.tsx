        ...
        >
          ...
          <div className="space-y-4">
            <a 
              ...
              className="flex items-center gap-4 p-4 rounded-xl glass-card hover:border-[var(--signal)]/30 transition-all group"
            >
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-[var(--signal)] group-hover:scale-110 group-hover:bg-[var(--signal)]/8 transition-all">
            ...
            <div className="flex items-center gap-4 p-4 rounded-xl glass-card group">
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-[var(--signal)]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    type="text"
                    id="name"
                    className="w-full bg-[#050508] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[var(--signal)] focus:ring-1 focus:ring-[var(--signal)] transition-all placeholder:text-gray-600"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  id="message"
                  rows={4}
                  className="w-full bg-[#050508] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[var(--signal)] focus:ring-1 focus:ring-[var(--signal)] transition-all placeholder:text-gray-600 resize-none"
